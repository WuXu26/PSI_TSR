...
df=pd.read_csv('sample_details_psi_ab_mix1.csv') #Change here for different sample details file
...
counter=0
drug_coord_dict={}
Output_Folder_Path="/ddnB/work/wxx6941/TSR/code/code/psi_revision/9pdb/output_trp_a_b_rmsd"
            ...
            for residue in chain:
                ...
                if resName == 'TRP':
                    ...
                    for atom1 in residue:
                        count+=1
                    if count==14:
                        Drug=f'{PDB_ID}_{Chain_Name}_{resName}_{Res_Id}'
